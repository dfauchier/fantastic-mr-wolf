...
function handleFormSubmit(event) {  // handles form submit withtout any jquery
  ...
  if( !validEmail(email) ) {   // if email is not valid show error
    var emailcontainer = document.getElementById('form-email').parentElement;
    emailcontainer.className += " email-error";
    return false;
  } else {
